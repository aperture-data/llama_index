...
class ApertureDBGraphStore(PropertyGraphStore):
    ...
    def upsert_triplet(self, sub: str, rel: str, obj: str) -> None:
        ...
        query = [
            QueryBuilder.add_command(
                ...
                params={
                    "_ref": 1,
                    "properties": {"label": sub},
                    "if_not_found": {"label": ["==", sub]},
                },
            ),
            QueryBuilder.add_command(
                oclass="KG_Node",
                params={
                    ...
                    "if_not_found": {"label": ["==", obj]},
                },
            ),
            QueryBuilder.add_command(
                oclass=ObjectType.CONNECTION,
                params={
                    "class": "KG_Connection",
                    "properties": {"label": rel},
                    "src": 1,
                    "dst": 2,
                },
            ),
    ...
    def get_rel_map(
        self, subjs=None, depth: int = 2, limit: int = 30
    ...
    def upsert_relations(self, relations):
        ...
        for i, r in enumerate(relations):
            query = [
                {
                    "FindEntity": {
                        "constraints": {UNIQUEID_PROPERTY: ["==", r.source_id]},
                        "_ref": 1,
                    }
                },
                {
                    "FindEntity": {
                        "constraints": {UNIQUEID_PROPERTY: ["==", r.target_id]},
                        "_ref": 2,
                    }
                },
                {
                    "AddConnection": {
                        ...
                        # "if_not_found": {UNIQUEID_PROPERTY: ["==", r.id]},
                    }
                },
            ]
            result, response, _ = execute_query(
